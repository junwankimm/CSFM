...
def parse_configs(config_path: str) -> Tuple[DictConfig, DictConfig, DictConfig, DictConfig, DictConfig, DictConfig, DictConfig]:
    ...
    textve_config = config.get("text_ve", None)
    clip_config = config.get("clip", None)
    ...
    return rae_config, stage2_config, textve_config, clip_config, transport_config, sampler_config, guidance_config, misc, training_config
